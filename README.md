...
- `<<extend>>` Enviar notificacion SMS/Email:  De manera opcional, al momento de reservar un turno o ver su estado, puede recibir una notificación por SMS o Email.
